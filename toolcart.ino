...
#define TFT_CS D2     // SPI chip select
#define TFT_DC D5     // Data/command
#define TFT_RST D4    // Reset pin
#define GFX_BL D9     // Backlight

//Arduino_DataBus *bus = new Arduino_SWSPI(27 /* DC */, 5 /* CS */, 18 /* SCK */, 19 /* MOSI */, GFX_NOT_DEFINED /* MISO */);
//Arduino_DataBus *bus = new Arduino_ESP32SPI(D5, D2, D8, D10, GFX_NOT_DEFINED);
Arduino_DataBus *bus = new Arduino_SWSPI(TFT_DC, TFT_CS, TFT_SCLK, TFT_MOSI, GFX_NOT_DEFINED);
Arduino_GC9107 *gfx = new Arduino_GC9107(bus, TFT_RST, 0, true, 128, 128);
const int switchPins[NUM_SWITCHES] = { D1, D7 };
